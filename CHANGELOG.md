...
## [1.15.0](https://github.com/agile-north/dockship/compare/v1.14.0...v1.15.0) (2026-05-05)


### Features

* **tags:** add option to strip prerelease number from moving tags ([fda1bae](https://github.com/agile-north/dockship/commit/fda1baece33ebaaba88e967bbb13bd8b0f18800f))


### Bug Fixes

* **tests:** update assertions for suffixed versions in tags command ([bf3baa5](https://github.com/agile-north/dockship/commit/bf3baa5ccac7ac443a3216e596fcb81c26c60047))
* **tests:** update assertions for suffixed versions in tags command ([01a7923](https://github.com/agile-north/dockship/commit/01a7923da58754495b1284665c62193df54f0362))

## [1.14.0](https://github.com/agile-north/dockship/compare/v1.13.0...v1.14.0) (2026-04-30)


### Features

* **version:** add built-in gitversion provider ([0743706](https://github.com/agile-north/dockship/commit/0743706ede1e3ed33b5a0b68f3a3ab5099549c91))
* **version:** add built-in gitversion provider ([8db9f5a](https://github.com/agile-north/dockship/commit/8db9f5acf3e3a40391236bd30bf51f3847a48841))
...
* respect tagMode replace for branch-only alias rules and preserve semver suffixes ([699757e](https://github.com/agile-north/dockship/commit/699757ee18f184d2f36e95dca1246a91f0520f11))
* respect tagMode replace for branch-only alias rules and preserve semver suffixes ([be21c53](https://github.com/agile-north/dockship/commit/be21c5305ce9140530f8086e662ab0dbb5f279bc))

## [1.12.2](https://github.com/agile-north/dockship/compare/v1.12.1...v1.12.2) (2026-04-23)


### Bug Fixes

* document alias rule version matching and support branch/version match conditions ([d9626f8](https://github.com/agile-north/dockship/commit/d9626f8cea51a3da7179f0cbd6fbfde14e0f278f))
* preserve version suffix for generic replace rules while enabling version-specific suffix replacement ([dc65c35](https://github.com/agile-north/dockship/commit/dc65c350d059f3b7d6feacd47c9212ddb50afc7d))
* support branch/version alias matching and document matchBranch/matchVersion ([85e2dcd](https://github.com/agile-north/dockship/commit/85e2dcd624141dffc141ab450ad8cd9901db3d9e))

## [1.12.1](https://github.com/agile-north/dockship/compare/v1.12.0...v1.12.1) (2026-04-23)


### Bug Fixes

* support docker.tags.aliases and use -pre guardrail suffix for non-public tags ([0687105](https://github.com/agile-north/dockship/commit/0687105745c0204534fcb229e85a92a81a31f7c2))

## [1.12.0](https://github.com/agile-north/dockship/compare/v1.11.2...v1.12.0) (2026-04-23)


### Features

* add strict config mode and branch pattern shortcuts ([7b4eddd](https://github.com/agile-north/dockship/commit/7b4eddd8f3e1c71f25b7983c9b30e466cbf31785))

## [1.11.2](https://github.com/agile-north/dockship/compare/v1.11.1...v1.11.2) (2026-04-23)


### Bug Fixes

* Refactor alias rule engine with case-insensitive matching, $0 support, and docs ([81fc88d](https://github.com/agile-north/dockship/commit/81fc88d333ae322b2b932e75a9391afe62e58784))

## [1.11.1](https://github.com/agile-north/dockship/compare/v1.11.0...v1.11.1) (2026-04-23)


### Bug Fixes

* Add backward-compatible global alias sanitize setting and docs ([25def44](https://github.com/agile-north/dockship/commit/25def4453c1a741d274ed6493baf6bda938ecbcb))

## [1.11.0](https://github.com/agile-north/dockship/compare/v1.10.4...v1.11.0) (2026-04-23)


### Features

* improve alias rule documentation and semantic tag transform behavior ([a4a3c87](https://github.com/agile-north/dockship/commit/a4a3c87297cf7f03d487cfa8862d373d6a42307b))
